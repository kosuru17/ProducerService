...
@Component
@Order(-2)
public class LocationExceptionHandler extends AbstractErrorWebExceptionHandler {
    public LocationExceptionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources, ApplicationContext applicationContext, ServerCodecConfigurer configurer) {
